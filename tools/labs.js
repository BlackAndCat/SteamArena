...
SA.LABS = {
  ...
  ITEMS: [
    ...
    { id: 'cannon-s', group: 'module', url: 'cannon-s-lab.html', name: '小炮 · 造型与材质语法', ver: 'v1', date: '2026-09-26', status: 'explore',
      desc: '五个造型方向（小炮塔 / 舰炮座 / 卡隆短炮 / 炮窗 / 喇叭口）× 六种材料；材料换零件画法而不是换色', docs: ['docs/board-opus.md'] },
