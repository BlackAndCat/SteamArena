...
| K 战役方向 | `docs/campaign-direction.md` §9：K1 跳弹、K2 反震、K3 修理费比例、K4 战役重排、K5 唯一件、K6 支线、K7 重打、K8 进化生成器联动、K9 早期近战验证。K1～K3 属于战斗规则，要在冻结点之前完成 | 待做 |
| B 数值与平衡 | 热量、平局、结局分布先按 `docs/evolve-plan.md` P2 系统健康测试做；经济、材料和模块的价值关系；补"贪心玩家"经济模拟 | 待做 |
| J 关卡车进化生成器 | `docs/evolve-plan.md` P0～P8。P0 和任务 F 一起做；正式生成等战斗规则冻结点 | 待做 |
