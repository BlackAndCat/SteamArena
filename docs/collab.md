...
| 项 | 内容 | 状态 |
|---|---|---|
| A 模块机制 | `docs/codex-task-systems.md` 全部：6 个假机制做成真的、补 6 个模块、Boss 件特性、多行遮挡、街头赛按解锁取件、敌车示范、参考车修正、AI、评分、生效统计 | 待做 |
| A′ 辅助设备迁移 | 4 种辅助设备全部做成 1×1 实体，删除 `SA.AUX` 和驾驶舱槽位；存档、分享码、蓝图迁移 | 待做（和 A 一起做） |
