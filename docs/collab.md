...
| K 战役方向 | `docs/campaign-direction.md` §9：K1 跳弹、K2 反震、K3 修理费比例、K4 战役重排、K5 唯一件、K6 支线、K7 重打、K8 进化生成器联动、K9 早期近战验证。K1～K3 属于战斗规则，要在冻结点之前完成 | 进行中（K1～K5 第一版完成，K4/K5 待用户审阅；K6～K9 待做） |
